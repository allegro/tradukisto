...
class CroatianValuesTest extends Specification {

    static intConverter = croatianContainer().getIntegerConverter()
    static longConverter = croatianContainer().getLongConverter()
