...
class PolishValuesTest extends Specification {
    ...
    static intConverter = polishContainer().getIntegerConverter()
    static longConverter = polishContainer().getLongConverter()

    @Unroll
    def "should convert #value to '#words' in Polish"() {
        expect:
    ...
    @Unroll
    def "should convert long #value to '#words' in Polish"() {
        expect:
