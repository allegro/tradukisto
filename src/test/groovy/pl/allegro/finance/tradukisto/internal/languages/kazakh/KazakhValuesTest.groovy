...
class KazakhValuesTest extends Specification {
    ...
    static intConverter = kazakhContainer().getIntegerConverter()
    static longConverter = kazakhContainer().getLongConverter()
    ...
    @Ignore("Needs Kazakh long converter and values for trillion, quadrillion, quintillion")
    @Unroll
    def "should convert long #value to '#words' in Kazakh"() {
        expect:
