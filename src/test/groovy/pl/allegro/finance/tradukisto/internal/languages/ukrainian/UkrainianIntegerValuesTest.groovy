...
class UkrainianIntegerValuesTest extends AbstractIntegerValuesTest {

    def setup() {
        intConverter = ukrainianContainer().getIntegerConverter()
    }
    ...
    private static integerTranslations = [
            ...
            11_000       : "одинадцять тисяч",
            15_000       : "п'ятнадцять тисяч",
            ...
            322_089_890  : "триста двадцять два мільйони вісімдесят дев'ять тисяч вісімсот дев'яносто",
