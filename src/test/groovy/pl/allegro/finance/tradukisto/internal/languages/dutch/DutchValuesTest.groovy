...
class DutchValuesTest extends Specification {

    static intConverter = dutchContainer().getIntegerConverter()
    static longConverter = dutchContainer().getLongConverter()

    @Unroll
    def "should convert #value to '#words' in Dutch"() {
        expect:
