...
class PolishBaseValues {
    private static Map<Integer, String> numbers = ImmutableMap.<Integer, String>builder()
            .put(0, "zero")
            .put(1, "jeden")
            .put(2, "dwa")
            .put(3, "trzy")
    ...
    private static List<PolishPluralForms> pluralForms = Arrays.asList(
    ...
    public static List<PolishPluralForms> getPluralForms() {
        return pluralForms;
    }
}
